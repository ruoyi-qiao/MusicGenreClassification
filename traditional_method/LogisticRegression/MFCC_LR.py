...
# 训练逻辑回归模型
MFCC_best_params = {'C': 0.01, 'penalty': 'l2', 'max_iter': 1000}
MFCC_model = LogisticRegression(**MFCC_best_params, random_state=42)
...
MFCC_output_result_path = "MFCC_LR_Result.txt"
