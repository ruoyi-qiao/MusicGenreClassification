...
tpg_data_path = "D:\\dataset\\pca_oridata.csv"
...
# X_train_pca = pca.fit_transform(TPG_X_train)
# X_test_pca = pca.transform(TPG_X_test)
...
# 训练逻辑回归模型
TPG_best_params = {'C': 3, 'degree': 1, 'gamma': 0.01, 'kernel': 'rbf'}
...
y_pred_proba = TPG_model.predict_proba(TPG_X_test_scaled)
